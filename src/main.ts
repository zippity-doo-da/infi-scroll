...
const builderPreview = new URLSearchParams(window.location.search).get('builder') === '1';
const telemetryEnabled = new URLSearchParams(window.location.search).get('telemetry') === '1';
